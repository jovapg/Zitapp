...
export default function BusinessCalendar() {
        ...
        <div className="modal-dialog">
          <div className="modal-content" style={{backgroundColor: 'rgba(0, 0, 0, 0.8)', color: 'white', border: '1px solid rgba(255, 255, 255, 0.2)'}}>
            ...
            <div className="modal-body">
              <div className="mb-2">
                <strong>Negocio:</strong> {selectedAppointment.nombre_usuario}
              </div>
              <div className="mb-2">
            ...
            {filteredAppointments.map((app, idx) => (
              ...
              >
                <div className="d-flex w-100 justify-content-between">
                  <h5 className="mb-1">{app.nombre_usuario}</h5>
  ...
  return (
    <div className="container" style={containerStyle}>
      ...
      <h1 className="mb-4 text-white" style={{textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)'}}>Calendario de Citas</h1>
