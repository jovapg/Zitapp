            ...
            <div className="carousel-inner">
                ...
                <div className="d-flex justify-content-center gap-4">
                  <div className="benefit-card">
                    <div className="benefit-image bg-purple">
                      <img src="/img/camping.png" alt="Automatización" className="w-100" />
                    </div>
                    ...
                    <a href="#" className="btn btn-danger btn-sm">Explorar</a>
                  </div>

                  <div className="benefit-card">
                    <div className="benefit-image bg-purple">
                      <img src="/img/binoculars.png" alt="Analítica" className="w-100" />
                    </div>
                    <h5>Analítica</h5>
                  ...
                  <div className="benefit-card">
                    <div className="benefit-image bg-purple">
                      <img src="/img/hiking.png" alt="Adaptabilidad" className="w-100" />
                    </div>
              ...
              <div className="carousel-item">
                <div className="d-flex justify-content-center gap-4">
                  <div className="benefit-card">
                    <div className="benefit-image bg-purple">
                      <img src="/img/camping.png" alt="Visibilidad" className="w-100" />
                    </div>
                  ...
                  <div className="benefit-card">
                    <div className="benefit-image bg-purple">
                      <img src="/img/binoculars.png" alt="Credibilidad" className="w-100" />
                    </div>
                  ...
                  <div className="benefit-card">
                    <div className="benefit-image bg-purple">
                      <img src="/img/hiking.png" alt="Notificaciones" className="w-100" />
                    </div>
